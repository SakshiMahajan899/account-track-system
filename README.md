...
This is a simple Java-based bank account simulator. The system allows users to perform the following operations:

Withdraw money from their bank account.
Transfer money to another account.
Check the available balance of the account.
Pay using either a debit or credit card (with 1% extra charge on credit card transactions).
